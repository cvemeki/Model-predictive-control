...
%figure('Name','roll,pitch rate'); clf; 
subplot(2,3,5)
grid on; hold on;
...
if(~isempty(filter))
  ...
  %  figure('Name','z rate dist'); clf; 
   ...
   % figure('Name','yaw rate dist'); clf; 
    ...
    subplot(3,1,3)
    %figure('Name','roll,pitch rate dist'); clf; 
    grid on; hold on;
...
% subplot(2,3,1)
% % figure('Name','roll,pitch'); clf; grid on; hold on;
% grid on; hold on;
% title('roll,pitch');
% plot(t, theta(:,1)*180/pi, t, theta(:,2)*180/pi, 'LineWidth',1.1);
% plot(t, ref(2,:)*180/pi,'--', t, ref(3,:)*180/pi,'--','LineWidth',1.0);
...
% 
% subplot(2,3,2)
% % figure('Name','yaw'); clf; grid on; hold on;
% grid on; hold on;
% title('yaw');
% plot(t, theta(:,3)*180/pi,'LineWidth',1.1);
% plot(t,180*ref(4,:)/pi,'--')
...
% 
% subplot(2,3,3)
% % figure('Name','input'); clf; grid on; hold on;
% grid on; hold on;
% title('input');
% plot(t,repmat(sys.uMin(1),Ns)','--','Color','Red','LineWidth',2)
% plot(t,repmat(sys.uMax(1),Ns)','--','Color','Red','LineWidth',2)
...
% 
% subplot(2,3,4)
% % figure('Name','z rate'); clf; grid on; hold on;
% grid on; hold on;
% title('z rate');
% plot(t, zdot,'LineWidth',1.1);
% plot(t,ref(1,:),'--');
...
% 
% subplot(2,3,5)
% % figure('Name','roll,pitch rate'); clf; grid on; hold on;
% grid on; hold on;
% title('roll,pitch rate');
% plot(t, omega(:,1)*180/pi, t, omega(:,2)*180/pi,'LineWidth',1.1);
% plot(t,repmat(sys.angVelMin(1)*180/pi,Ns)','--','Color','Red','LineWidth',2)
% plot(t,repmat(sys.angVelMax(1)*180/pi,Ns)','--','Color','Red','LineWidth',2)
% legend('Roll rate', 'Pitch rate', 'Constraints');
...
% 
% subplot(2,3,6)
% % figure('Name','yaw rate'); clf; grid on; hold on;
% 
% grid on; hold on;
% title('yaw rate');
% plot(t, omega(:,3)*180/pi,'LineWidth',1.1);
